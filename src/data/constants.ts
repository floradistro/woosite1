...
export const products: ProductItem[] = [
  ...
  { id: 2, title: 'Pre-roll', description: 'Any of our flower strains, rolled fresh to order. Pick your strain, we roll it tight. Same premium flower, zero prep.', price: 0, image: '/icons/pre-roll.png', category: 'pre-roll', route: '/pre-roll' },
  { id: 3, title: 'Vape', description: 'Solventless liquid diamonds with real cannabis terpenes. No distillate, no fake flavors. Pure concentrate and natural terps.', price: 0, image: '/icons/vapeicon2.png', category: 'vape', route: '/vape' },
