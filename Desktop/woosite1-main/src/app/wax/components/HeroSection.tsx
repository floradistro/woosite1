...
export default function HeroSection({ format }: HeroSectionProps) {
  return (
    <>
      ...
      <section className="relative h-48 md:h-56 lg:h-64 overflow-hidden bg-[#4a4a4a] animate-fadeIn"
        style={{
          backgroundImage: `
            ...
            radial-gradient(circle at 60% 20%, rgba(255, 200, 0, 0.05) 0%, transparent 30%),
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center space-y-4 animate-fadeInUp px-6">
            <h1 className="text-white text-4xl md:text-5xl lg:text-6xl font-light tracking-wide transform hover:scale-105 transition-transform duration-200 uppercase">
              {format === 'wax' ? 'CONCENTRATES' : 'LIVE RESIN'}
            </h1>
            <h2 className="text-white/90 text-base md:text-lg lg:text-xl font-light tracking-wide max-w-2xl mx-auto drop-shadow-lg opacity-0 animate-fadeInUp" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
              {format === 'wax' 
                ? 'Pure extracts. Maximum potency. Premium quality.'
                : 'Fresh frozen. Solventless extraction. Full spectrum.'
              }
            </h2>
            <div className="flex flex-col items-center gap-2 mt-4 opacity-0 animate-fadeInUp" style={{ animationDelay: '1s', animationFillMode: 'forwards' }}>
              <div className="flex items-center gap-2 text-sm">
                <span className="text-amber-400 font-medium drop-shadow-md hover:text-amber-300 transition-colors duration-200">✓ 75-90% THCa</span>
                <span className="text-white/40">•</span>
                <span className="text-amber-400 font-medium drop-shadow-md hover:text-amber-300 transition-colors duration-200">✓ Lab Tested</span>
                <span className="text-white/40">•</span>
                <span className="text-amber-400 font-medium drop-shadow-md hover:text-amber-300 transition-colors duration-200">✓ Terpene Rich</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Quality Banner */}
      <div className="bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 py-2 text-center z-40">
        <div className="flex flex-wrap items-center justify-center gap-4 md:gap-8 px-4">
          <span className="text-white font-medium text-sm md:text-base">✓ Glass Stable</span>
          <span className="text-white/40">•</span>
          <span className="text-white font-medium text-sm md:text-base">
            ✓ {format === 'wax' ? 'Clean Melt' : 'Cold Cure'}
          </span>
          <span className="text-white/40">•</span>
          <span className="text-white font-medium text-sm md:text-base">
            ✓ {format === 'wax' ? 'No Residue' : 'Full Spectrum'}
          </span>
        </div>
      </div>
    </>
