        ...
        <div className="flex items-center justify-between gap-2 md:gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-6">
            ...
            <div className="hidden md:block text-sm text-white/70">
              {productCount} of {totalCount} {format === 'bottle' ? 'beverages' : 'packs'}
          ...
          <div className="flex items-center gap-2 md:hidden">
            <span className="text-xs text-white/70">
              {productCount} {format === 'bottle' ? 'drinks' : 'packs'}
            </span>
            <button
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none px-4 py-2 pr-10 bg-white/10 hover:bg-white/20 rounded-lg transition-all duration-300 cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
