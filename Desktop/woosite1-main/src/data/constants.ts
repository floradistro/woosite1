...
export const products: ProductItem[] = [
  ...
  { id: 4, title: 'Wax', description: 'Live resin, shatter, budder, and rosin. Potent, pure, and properly purged. For those who know the difference.', price: 0, image: '/categories/WAX.png', category: 'wax', route: '/wax' },
