        ...
        <div className="relative z-10 py-12 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8 opacity-0 animate-[fadeInUp_1s_ease-out_0.5s_forwards]">
              <button className="group px-8 py-4 bg-black hover:bg-gray-900 text-white font-semibold rounded-lg transition-all duration-300 hover:scale-105 active:scale-95 focus:outline-none focus:ring-0 select-none shadow-xl hover:shadow-2xl">
